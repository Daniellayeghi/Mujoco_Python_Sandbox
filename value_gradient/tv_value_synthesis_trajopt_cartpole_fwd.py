...
sim_params = SimulationParams(6, 4, 2, 2, 2, 1, 10, 300, 0.008)
cp_params = ModelParams(2, 2, 1, 4, 4)
prev_cost, diff, tol, max_iter, alpha, dt, n_bins, discount, step, scale, mode = 0, 100.0, 0, 500, .5, 0.008, 3, 1.0, 15, 100, 'fwd'
